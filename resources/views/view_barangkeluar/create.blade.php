...
@section('content')
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('barangkeluar.store') }}" method="POST" enctype="multipart/form-data">                    
                            ...
                            <!-- Tanggal Keluar Dibuat Default Sesuai Tanggal Barang Keluar -->
                            ...
                            <!-- Membuat Button Simpan, Reset, Batal -->
    ...
    <!-- Menambahkan Javascript Untuk Menjadikan Tanggal Barang Keluar Menjadi Default Sesuai Tanggal Hari Ini -->
    <script>
